...
export function OutlineNav({
  ...
  return (
    ...
    >
      ...
      {open && (
        <ul
          className="menu pointer-events-auto absolute top-1/2 left-5 z-20 max-h-[70%] w-64 flex-nowrap -translate-y-1/2 overflow-y-auto rounded-box border border-base-300 bg-base-100 p-1 shadow-lg"
          onMouseEnter={enter}
          onMouseLeave={leave}
        >
          {entries.map((e) => (
